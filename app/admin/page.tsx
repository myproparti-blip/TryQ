        ...
        if (selectedPage === "home") {
            return (
                <div className="space-y-8">
                    ...
                    {/* Status Banner */}
                    <div className="bg-gradient-to-r from-[#C6FF3A] via-green-500 to-teal-500 rounded-2xl p-6 text-black relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-r from-[#C6FF3A]/80 via-green-500/80 to-teal-500/80" />
                        ...
                        <div className="relative flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-black">All Systems Active</h3>
                                    <p className="text-black/70">Your website is live with real-time content management.</p>
                                </div>
                            </div>
                            <Button onClick={handlePreview} className="bg-black text-[#C6FF3A] hover:bg-black/80 font-bold px-6">
                                Preview Site →
                            </Button>
                        </div>
                    </div>
