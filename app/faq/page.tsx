...
export default function FAQPage() {
  const faqs = [
    {
      q: "What services does TryQ tech provide?",
      a: "TryQ tech delivers enterprise-grade IT solutions including cloud infrastructure, custom software development, DevOps & automation, security solutions, and 24/7 managed support for businesses of all sizes.",
    },
    {
