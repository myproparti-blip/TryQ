          ...
          <div className="grid gap-12 md:grid-cols-3 lg:grid-cols-4 mb-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold bg-gradient-to-r from-lime-300 to-white bg-clip-text text-transparent">TryQu Tech</span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <a href="mailto:tryqutech@gmail.com" className="text-sm text-neutral-300 hover:text-lime-300 transition-colors break-all">
                    tryqutech@gmail.com
                  </a>
                </div>
                <div className="pt-2">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <button onClick={handleChatClick} className="text-sm text-neutral-400 hover:text-lime-300 transition-colors flex items-center gap-2 group">
                    <span className="w-0 group-hover:w-1.5 h-0.5 bg-lime-400 transition-all" />
                    Privacy Policy
                  </button>
                </li>
