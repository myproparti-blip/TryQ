      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Learn industry-standard tools and technologies used by professional mobile developers
          </p>
        </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  {category.tools.map((tool, idx) => (
                    <div key={idx} className="pb-3 border-b border-slate-800/50 last:pb-0 last:border-0">
