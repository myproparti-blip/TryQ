                    ...
                    {mobileDevAreas.map((area) => (
                        ...
                        >
                            ...
                            <Card className="relative z-10 h-full bg-transparent border-0 shadow-none flex flex-col">
                                {/* Image Container */}
                                <div className="relative w-full h-40 overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900">
                                    <Image
                                        src={area.image}
                                        alt={area.title}
                                        width={400}
                                        height={300}
                                        className={`w-full h-full object-cover transition-transform duration-300 ${hoveredId === area.id ? 'scale-110' : 'scale-100'
                                            }`}
                                        unoptimized
                                    />
