                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-12 z-10">
                                    <div className={`space-y-4 transition-all duration-1000 ${isActive ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
                                        ...
                                        <div className="pt-4 flex gap-4">
                                            <div className="px-6 py-2 rounded-lg bg-lime-400/20 border border-lime-400/40 backdrop-blur-sm">
                                                <p className="text-sm text-lime-300 font-medium">Learn More</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
