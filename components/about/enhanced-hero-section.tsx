      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            {/* Primary Button */}
            <button className="group relative px-8 py-3 rounded-lg overflow-hidden font-semibold text-white transition-all duration-300">
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-blue-500 transition-all duration-300 group-hover:scale-110"></div>
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-r from-cyan-600 to-blue-600 blur transition-opacity duration-300"></div>
            ...
            {/* Secondary Button */}
            <button className="group px-8 py-3 rounded-lg border border-cyan-500/50 text-white font-semibold hover:border-cyan-400 transition-all duration-300 backdrop-blur-sm hover:bg-cyan-500/10 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/0 to-purple-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
