...
export function StorySection() {
  ...
  const milestones = [
    ...
    {
      year: '2016',
      title: 'First Unicorn Client',
      description: 'Delivered cloud platform serving 100M+ daily active users.',
      icon: '⭐',
    },
    {
      year: '2018',
      title: 'AI Division Launch',
      description: 'Established AI/ML research lab, pioneering deep learning solutions.',
      icon: '🧠',
    },
    {
      year: '2020',
      title: 'Global Expansion',
      description: 'Opened operations in 15 countries across 4 continents.',
      icon: '🌍',
    },
    {
      year: '2022',
      title: 'Cybersecurity Leader',
      description: 'Recognized as top-tier provider protecting Fortune 500 companies.',
      icon: '🛡️',
    },
    {
      year: '2024',
      title: 'Industry Innovator',
      description: 'Leading the charge in quantum-safe cryptography and edge AI.',
      icon: '⚡',
    },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            A decade of relentless innovation, transforming how enterprises harness technology.
          </p>
        </div>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl text-center hover:border-cyan-500/50 transition-all duration-300">
            ...
            <p className="text-slate-300 mt-3">Global Enterprise Clients</p>
          </div>
