    ...
    <section className="py-24 px-4 bg-gradient-to-b from-black to-blue-950/20 relative">
      ...
      <div className="relative container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-black tracking-tight text-white mb-4">Why Choose TryQ Tech</h2>
            ...
            <table className="w-full text-sm sm:text-base">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="text-center py-4 px-4 text-cyan-400 font-semibold">TryQ Tech</th>
