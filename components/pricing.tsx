      ...
      <div className="container mx-auto px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-2 max-w-xl text-sm text-neutral-300" itemProp="description">
            No hidden costs. Enterprise-grade IT services built for your budget.
          </p>
          <div className="mt-6">
            <Button
              asChild
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          ...
          >
            ...
            <CardHeader className="space-y-3 pb-4">
              ...
              <div className="flex items-end gap-2 text-white">
                ...
                <span className="pb-0.5 text-[11px] text-neutral-300">per project</span>
            ...
            <CardContent className="pt-0">
              <ul className="grid gap-2" itemProp="description">
                {[
                  ...
                  "Basic Security & Analytics - Included",
                ].map((f, i) => (
          ...
          >
            ...
            <CardContent className="pt-0">
              <ul className="grid gap-2" itemProp="description">
                {[
                  "Custom Software Application (Single Module)",
                  "Detailed requirements & specification docs",
                  "Advanced features & integrations",
                  "Unlimited revisions (30 days)",
                  "Delivered in 6 weeks",
                  "Security, Testing & Deployment - Included",
                ].map((f, i) => (
                  <FeatureItem key={i} text={f} />
                ))}
              </ul>
          ...
          >
            ...
            <CardContent className="relative pt-0">
              <ul className="grid gap-2" itemProp="description">
                {[
                  "Enterprise Software Suite (Multiple Modules)",
                  "Advanced architecture & design documentation",
                  "Delivered in 12 weeks",
                  "AI/ML integration, Advanced Analytics, Custom Reporting",
                  "Unlimited revisions & change requests",
                  "24/7 Support, Maintenance & Optimization - Included",
                ].map((f, i) => (
